...
public class DisasterState implements State {
	DroneMngmtStates droneMngmtStates;
	public DisasterState(DroneMngmtStates droneMngmtStates) {
	...
	public void deliver() {
		...
		droneMngmtStates.setState(droneMngmtStates.getDeliverSuppliesState());
