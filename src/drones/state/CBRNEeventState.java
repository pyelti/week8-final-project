...
public class CBRNEeventState implements State{

	
	DroneMngmtStates droneMngmtStates;
	public CBRNEeventState(DroneMngmtStates droneMngmtStates) {
	...
	public void findLocation() {
		...
		droneMngmtStates.setState(droneMngmtStates.getDisasterState());
